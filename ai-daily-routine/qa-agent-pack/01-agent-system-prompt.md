...
3. Upload the 5 skill files (`02-skill-test-case-generator.md` through `06-skill-test-plan-writer.md`) as knowledge files
...
| File | When to use |
|------|-------------|
| `02-skill-test-case-generator.md` | "Generate test cases for [feature/story]" |
| `03-skill-bug-report-formatter.md` | "Format this bug" / "Turn my notes into a report" |
| `04-skill-edge-case-brainstormer.md` | "What edge cases am I missing?" |
| `05-skill-regression-tracker.md` | "Help me plan/summarize regression" |
| `06-skill-test-plan-writer.md` | "Write a test plan for [release/sprint]" |
