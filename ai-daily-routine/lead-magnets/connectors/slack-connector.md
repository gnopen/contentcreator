...
- `google-drive-connector.md` — Sync test artifacts to Drive (often used alongside Slack alerts)
- `qa-pack/04-skill-regression-tracker.md` — Generates the regression summaries that you'd post to Slack
- `qa-pack/02-skill-bug-report-formatter.md` — Generates the bug reports that you'd escalate to `#bugs-critical`
