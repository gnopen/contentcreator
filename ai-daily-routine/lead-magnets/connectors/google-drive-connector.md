...
5. Post link to Slack (chain with `slack-connector.md`)
...
1. **Generate** — Claude/agent produces a test report (using `qa-pack/04-skill-regression-tracker.md`)
2. **Archive** — Upload to Drive (this connector)
3. **Announce** — Post link to Slack (using `slack-connector.md`)
...
- `slack-connector.md` — Pair Drive uploads with Slack notifications
- `qa-pack/00-qa-agent-system-prompt.md` — The agent that generates the content you'll be archiving
